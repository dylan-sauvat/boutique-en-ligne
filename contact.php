...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_name" placeholder="Entrer votre nom">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Addresse Mail</label>
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Entrer votre addresse Mail">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Téléphone</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Entrer votre numéro de téléphone">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                <input type="submit" value="Envoyer" class="btn btn-primary pull-right" name="form_contact">
                                </div>
                            </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Nos Coordonées</legend>
                        <address>
