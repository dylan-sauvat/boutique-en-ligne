...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" Aucun produits disponible pour "'.$arr3[$i].'"\n';
        } else {
	...
	<?php else: ?>
		<script>alert('Le Panier à été mise à jour!');</script>
	<?php endif; ?>
    <?php
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    ...
                    <?php echo '<h4 class="text-center">Ajouter un Produit au Panier pour le voir ici</h4>'; ?>
                <?php else: ?>
